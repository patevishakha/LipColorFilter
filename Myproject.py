...
def createBox(img,points,masked= False,cropped= True):
    if masked:
    ...
    if cropped:
        ...
        imgCrop = cv2.resize(imgCrop,(0,0),None,7,7)
...
while True:
    ...
    for face in faces:
        ...
        if len(myPoints) != 0:
            try:
                ...
                imgColorLips[:] = b,g,r  #coloring complete box with particular color
    ...
    #cv2.imshow("Originial", imgOriginal)   # original image
    cv2.waitKey(1)